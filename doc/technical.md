...
- 游戏：Liquid Drop
- 类型：casual
- 简述：Tap to bloom — color blooms across the canvas, overlaps, slowly fades. Three liquids: glossy oil beads on a midnight pool, cream into coffee, acrylic on black. Each tap rings a pentatonic note.
- 框架 / 语言 / 构建：TypeScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Liquid Drop；cover_url=/poster.png；category=casual；uuid=e1a50130-a97a-400c-a4c9-458bb2c26223
